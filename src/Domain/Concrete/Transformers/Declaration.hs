...
-------------------------------------------------------------------------------
-- Module    :  Domain.Concrete.Transformers.Declaration
...
import Domain.Concrete.API (write_memory_addr)
...
transformer_init :: SymId -> STy -> Maybe (Initializer SymId ()) -> ConTOp ConAct
...
default_value :: Ty SymId () -> ConTOp ([ConValue], ConAct)

...
// to be called from the first line of main()
char *poet_environ[2] = {"TEST=test", 0};
...
#if 0
__noreturn __libc_init_orig (uintptr_t * elfdata, void (*onexit) (void))
{
	int argc;
...
#define MAIN main
	...
	__page_size = page_size = __auxval[AT_PAGESZ]; // xxxxxxxxxxxxxxxxxxxx
...
#endif
	__page_shift = page_shift; // xxxxxxxxxxxxxx
